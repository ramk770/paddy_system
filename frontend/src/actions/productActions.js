...
export const getProduct = id => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`${localhost}/api/v1/product/${id}`);
...
export const createReview = reviewData => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`${localhost}/api/v1/review`,reviewData, config);
...
export const getAdminProducts  =  async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`${localhost}/api/v1/admin/products`);
...
export const createNewProduct  =  productData => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.post(`${localhost}/api/v1/admin/product/new`, productData);
...
export const deleteProduct  =  id => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`${localhost}/api/v1/admin/product/${id}`);
...
export const updateProduct  =  (id, productData) => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`${localhost}/api/v1/admin/product/${id}`, productData);
...
export const getReviews =  id => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`${localhost}/api/v1/admin/reviews`,{params: {id}});
...
export const deleteReview =  (productId, id) => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`${localhost}/api/v1/admin/review`,{params: {productId, id}});
